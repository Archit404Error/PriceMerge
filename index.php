<html>
  ...
  <body>
    ...
    <!-- Landing Start -->
    <div class="outer mw-100 container landingGradient">
      <div class = "inner mw-100">
        <div style = "height: 15vh"></div>
        <div class = "row">
            <div class = "col-md-5 offset-md-1 col-sm-12 animated wow fadeInUp">
                <h1 style = "font-size: 8vh;">E-commerce Made Faster, Safer, and Cheaper.</h1>
                <div style = "height: 3vh;"></div>
                <h3 style = "font-size: 3vh">Save money and time while shopping online by tracking products across thousands of sites and recieving alerts when prices fall!</h3><br>
                <a href = "productdisplay.php"><button class = "btn btn-primary col-md-3 col-sm-6" style = "font-size: 2vh">Start Saving!</button></a>
            </div>
            <div class = "d-none d-md-block col-md-5 text-center">
                <img class = "img-fluid" src = "homePic.png">
                <div style = "height: 5vh"></div>
                <center><h3>As seen on ABC News, NJ News Network, and several others!</h3></center>
            </div>
        </div>
        <div style = "height: 15vh"></div>
        <div class = "row d-none d-md-block" style = "height: 10vh">
            <div class = "alternate-info-section col-md-6 offset-md-3" style = "border-radius: 20px; background: #ff9500; padding: 5%;">
