            ...
            function scrapeSite($siteURL, $listingClass, $listingOffset, $priceClass, $priceOffset, $linkClass, $linkOffset, $item){
                ...
                if(!empty($dom)){
                    ...
                    if(strpos($price, "from") === false){
                        ...
                        echo "<div class = 'row justify-content-center'><a href = 'http://www.pricemerge.com/productdisplay.php'><button class = 'btn btn-primary'>Return to Tracker</button></a></div>";
                        echo "<div style = 'height: 2vh'></div>";
                        echo "<div class = 'row'>";
